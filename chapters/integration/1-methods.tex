...
\paragraph{Null Cell}
The bipartite matching approach makes the assumption that each cell has a singular corresponding sibling in its paired technology.
