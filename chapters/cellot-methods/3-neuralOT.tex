...
Thanks to a series of results often attributed to Brenier \cite{brenier, need}
some convenient simplifications can be made to the Kantorovich dual formulation \ref{eq:ot-dual}.

These are summarized in \citet[Theorem 2.9]{villani2021topics} where the dual problem \ref{eq:ot-dual} over the pair of functions $(f, g)$ is simplified to
