...
% TODO: [one more sentence on why scDRs are great and different to other was of looking at clinical samples]  
...
Other spatial and multi-modal profiles available both before and after treatment can be incorporated by learning integrative representations \cite{SCIM, GLUE}.
...
Single-cell foundation models \cite{geneformer scgpt, review}, which utilize cutting edge architectures that have had major success in modeling the complexities of language \cite{attn all you need, bert, gpt},
