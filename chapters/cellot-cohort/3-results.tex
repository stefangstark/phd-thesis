...
% TODO: enter all XX placeholders
...
\subsection{Predicting drug responses of unseen patients}
...
The random forest trained on sample metadata and SVM classification using control states only struggle to perform, yielding accuracies of XXX +/- XX. % TODO: values
The SVM classification using treated states fares slightly better, reporting accuracies of XXX +/- XX. % TODO: values
We see the most drastic improvement using \emph{response} information, which reports accuracies of XXX +/- XX. % TODO: values
% TODO: add fig
